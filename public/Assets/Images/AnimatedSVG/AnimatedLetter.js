...
const AnimatedLetter = ({className = null}) => {
	const isLoadingAnimationComplete = useSelector(
		(state) => state.loading.isLoadingAnimationComplete
	  );

  const lineVariants_dot = {
    initial: {
      strokeDasharray: 63.46,
      strokeDashoffset: 63.46,
      transition: { duration: 0 },
    },
    animate: {
      strokeDashoffset: [63.46, 0],
      transition: {delay:2.8, duration: 0.6 },
    },
  };

  const lineVariants_l = {
    initial: {
      strokeDasharray: 487.23,
      strokeDashoffset: 487.23,
      transition: { duration: 0 },
    },
    animate: {
      strokeDashoffset: [487.23, 0],
      transition: {delay:2.5, duration: 0.6 },
    },
  };

  const lineVariants_i = {
    initial: {
      strokeDasharray: 307.87,
      strokeDashoffset: 307.879,
      transition: { duration: 0 },
    },
    animate: {
      strokeDashoffset: [307.879, 0],
      transition: {delay:1.3, duration: 0.6 },
    },
  };

  const lineVariants_a = {
    initial: {
      strokeDasharray: 731.169,
      strokeDashoffset: 731.169,
      transition: { duration: 0 },
    },
    animate: {
      strokeDashoffset: [731.169, 0],
      transition: {delay:2.2, duration: 0.6 },
    },
  };

  const lineVariants_u = {
    initial: {
      strokeDasharray: 807.402,
      strokeDashoffset: 807.402,
      transition: { duration: 0 },
    },
    animate: {
      strokeDashoffset: [807.402, 0],
      transition: {delay:1.9, duration: 0.6 },
    },
  };

  const lineVariants_s = {
    initial: {
      strokeDasharray: 349.211,
      strokeDashoffset: 349.211,
      transition: { duration: 0 },
    },
    animate: {
      strokeDashoffset: [349.211, 0],
      transition: {delay:1.6, duration: 0.6 },
    },
  };

  const lineVariants_v = {
    initial: {
      strokeDasharray: 736.95,
      strokeDashoffset: 736.95,
      transition: { duration: 0 },
    },
    animate: {
      strokeDashoffset: [736.95, 0],
  ...
  return (
    <svg
	  ...
	  className={`${className}`}>
      <defs>
        <clipPath id="clipPath" transform="translate(31.09 32.56)">
          <path
            id="dot_clip"
        ...
        <clipPath id="clipPath-2" transform="translate(31.09 32.56)">
          <path
            id="l_clip"
        ...
        <clipPath id="clipPath-3" transform="translate(31.09 32.56)">
          <path
            id="i_clip"
        ...
        <clipPath id="clipPath-4" transform="translate(31.09 32.56)">
          <path
            id="a_clip"
        ...
        <clipPath id="clipPath-5" transform="translate(31.09 32.56)">
          <path
            id="u_clip"
        ...
        <clipPath id="clipPath-6" transform="translate(31.09 32.56)">
          <path
            id="s_clip"
        ...
        <clipPath id="clipPath-7" transform="translate(31.09 32.56)">
          <path
            id="v_clip"
